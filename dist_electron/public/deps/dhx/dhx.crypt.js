...
/*global $dhx, dhtmlx */
// please check https://github.com/bitwiseshiftleft/sjcl
(function(namespace) {
    'use strict';
...
(function(namespace) {
    ...
    setRSA64: function(originalStr) {
        return $dhx.crypt.Base64.encode(originalStr);
    },
    getRSA64: function(criptStr) {
        return $dhx.crypt.Base64.decode(criptStr);
    }
});
