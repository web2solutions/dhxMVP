            ...
            view = new child_view({
                ...
                _grid_ips: function() {
                    ...
                    if (self.grid_ips === null) {
                        ...
                        wrapper = self.form.getContainer("assigned_ips");
                        ...
                        self.grid_ips.setHeader(self._settings.grid_ips.header.join(',') + ',Assigned');
                        self.grid_ips.setColumnIds(self._settings.grid_ips.id.join(',') + ',assigned');
                        self.grid_ips.enableAutoWidth(true);
                        self.grid_ips.setInitWidths('0,0,0,*,120,90');
                        //console.log( self._settings.grid.id.join(',') );
