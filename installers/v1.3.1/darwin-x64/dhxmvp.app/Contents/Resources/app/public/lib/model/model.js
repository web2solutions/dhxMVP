                ...
                API = {
                    ...
                    start: function() {
                        ...
                        var initialize = function() {
                            ////$dhx.debug.log( this );
                            ////$dhx.debug.log("MODEL:: model.data." + this.storeName + "." + this.id + " initialized");
                        };
                ...
                create_database: function(c, model) {
                    var self = _private,
                        ...
                        add_all = function(  done, c_names, m_names ){
                            $dhx.debug.log( c_names );
                            $dhx.debug.log( m_names );
                    ...
                    if (record) {
                        ...
                        m.save(record, {
                            ...
                            error: function(o, error) {
                                $dhx.debug.error( error.srcElement.error.message );
                                $dhx.debug.error( 'error inserting record: ', record );
                                $dhx.debug.warn('props: ', Object.keys(record).length );
