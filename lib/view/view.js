                ...
                _settings: {
                    ...
                    toolbar: {
                        ...
                        items: [{
                            ...
                            type: "text",
                            id: "title",
                            text: "<img src='"+app.root+"assets/icons/64/dashboard.png' width='32' style='position:relative;float:left; margin-top:10px; margin-right: 10px;' /><span style='font-weight: bold; font-size: 14px;'>Dashboard</span>"
                        }, {
