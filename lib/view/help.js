            ...
            view = new child_view({
                ...
                _grid: function() {
                    ...
                    if (this.grid === null) {
                        ...
                        this.grid.setHeader(self._settings.grid.header);
                        this.grid.setInitWidths(self._settings.grid.width);
                        this.grid.setColAlign(self._settings.grid.colAligns);
                        this.grid.setColTypes(self._settings.grid.colTypes);
                        //this.grid.enableMultiline(true);
                        this.grid.init();
                        this.grid.load("http://localhost/dhxMVP/help.json", "json");
                ...
                _form: function() {
                    ...
                    self._settings.grid.id.split(',').forEach(function(id, index) {
                        var header = self._settings.grid.header.split(',')[index],
