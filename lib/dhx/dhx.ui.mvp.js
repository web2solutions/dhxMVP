        ...
        dispatch: function(route, addEntry) {
            ...
            if (this.routes[active_route].presenter) {
                ...
                if (this.routes[active_route].view) {
                    deps.push("lib/view/" + ($dhx.environment != 'test' ? "min." : "") + this.routes[active_route].view + ".js");
                }
                deps.push("lib/presenter/" + ($dhx.environment != 'test' ? "min." : "") + this.routes[active_route].presenter + ".js");
                ...
                if (this.routes[active_route].append_views) {
                    this.routes[active_route].append_views.forEach(function(stash) {
                        deps.push("lib/view/" + ($dhx.environment != 'test' ? "min." : "") + stash[Object.keys(stash)[0]] + ".js");
                    });
                }
