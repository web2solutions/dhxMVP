        ...
        API = {
            ...
            form_process:function( ){
                ...
                if (view.form.check()) {
                    ...
                    if( record.purchase )
                    {
                        record.purchase = (new Date(record.purchase)).getTime();
                    }
                        ...
                        if( action == 'update' )
                        {
                            ...
                            self.model.schema.io[ collection ].read({
                                ...
                                onSuccess: function( model ) {
                                    ...
                                    hash.purchase = new Date(hash.purchase);
            ...
            show_item: function() {
                ...
                self.model.schema.io[ collection ].read({
                    ...
                    onSuccess: function( model ) {
                        ...
                        view.layout.cells('b').setText(model.get('name'));
            ...
            destroy_item: function() {
                ...
                if( view.layout )
                {
                    ...
                    view.layout.cells('b').setText('Select a Server first');
                }
