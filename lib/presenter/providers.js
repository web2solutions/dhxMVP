                    ...
                    else if( message.collection == 'ips' )
                    {
                        ...
                        else if( message.method == 'update')
                        {
                            view.ips._settings.grid.id.forEach(function(col_id, index) {
                                console.log( col_id, view.ips.grid.getColIndexById(col_id) );
                                view.ips.grid.cells(message.model.id, view.ips.grid.getColIndexById(col_id)).setValue(message.model[ col_id ]);
                            });
            ...
            show_item: function() {
                ...
                self.model.schema.io[ collection ].read({
                    ...
                    onSuccess: function( model ) {
                        ...
                        view.layout_servers.cells('b').collapse();
