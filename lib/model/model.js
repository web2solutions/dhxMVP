                ...
                "1": {
                    ...
                    "users": {
                        ...
                        defaults: {
                            ...
                            /*
                                type of user: https://trello.com/c/z2q33rZX/28-questions

                                TYPES OF USERS: XpertMinds Project Manager                    - XPM
                                XpertMinds Admin                                              - XA
                                Client (Posting Jobs, Seeking Consultants/Xperts)             - Client
                                Consultant/Xpert (Seeking Jobs, Posting Bids, Work Progress)  - Xpert
                            */
                            type: {
                                type: String,
                                default: 'Xpert',
        ...
        API = {
            ...
            start: function() {
                ...
                for (var name in _collections) {
                    ...
                    // create model
                    //API[_collections[name].item] = function(s) {
                    //    $dhx.debug.log(name);
