            ...
            var _collections = {},
                ...
                API = {
                    ...
                    setIoAPI : function(collectionName, modelName){
                        ...
                        model.schema.io[ collectionName ] = (function(modelName) {
                            var api = {
                                model: modelName,
                                create: function(c) {
                                    c.model = this.model;
        ...
        model.schema = (function() {
            var _private = {
                setup: function(c) {
                    ...
                    if (c.onSetup) c.onSetup();
                    //self.add_all_records_from_server();
                    //};
                    //complete();
                },
                ...
                add_all_records_from_server: function(c) {
                    var self = _private,
                    ...
                    tables.forEach(function(collection, index) {
                        ...
                        //console.log('collections[ collection ]: ', collections[ collection ]);
                        //console.log('c_names: ', c_names );
                            ...
                            mm.fetch({
                                success: function(mmm) {
                                    if (fDocument.__v > mmm.get('__v')) {
                                        ...
                                        console.warn('_io._create() -> Record rejected. The version of the record is not greater than local record version.', fDocument);
                                        if (c.onSuccess) c.onSuccess( fDocument );
                                    }
                                },
                                error: function(o, error) {
                            ...
                            success: function(model) 
                            {
                                ...
                                if (fDocument.__v) {
                                    ...
                                    if (fDocument.__v > model.get('__v')) {
                                        ...
                                        console.warn('_io._update() -> Record rejected. The version of the record is not greater than local record version.', fDocument);
                                        if (c.onSuccess) c.onSuccess( fDocument );
                                    }
                                } else {
            ...
            API = {
                ...
                add_all_records_from_server: _private.add_all_records_from_server,
                io: _private.io,
                _io: _private._io
            };
            return API;
